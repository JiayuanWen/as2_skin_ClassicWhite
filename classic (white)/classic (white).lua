...
do --Rings
    if quality < 2 then
        ringTexture = "Classic420p.png"
    elseif quality < 3 then
        ringTexture = "Classic720p.png"
    elseif quality < 4 then
        ringTexture = "Classic1080p.png"
    else
        ringTexture = "Classic2160p.png"
    end
...
do --End of track object (Also known as endcookie)
    if quality < 2 then
        portalTexture = "Portal_Low.png"
    elseif quality < 3 then
        portalTexture = "Portal_Med.png"
    elseif quality < 4 then
        portalTexture = "Portal_High.png"
    else
        portalTexture = "Portal_Ultra.png"
    end
